class SalonsController < ApplicationController
  ...
  private
    ...
    def salon_params
      params.require(:salon).permit(:name, :main_image, :description, :location, :active, :listed, :amenities => [], :key_product_list => [], :specialities => [], :payment_options => [], :categories => [], :services => [], :ambience => [])
    end
end
